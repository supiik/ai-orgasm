...
class PlaylistRepositoryIT {
    ...
    void save_persistsPlaylist() {
        Playlist saved = repository.save(new Playlist(null, "My Mix", "a description", PlaylistStatus.NEW, null, null));
    ...
    void findById_returnsPlaylist_afterSave() {
        Playlist saved = repository.save(new Playlist(null, "Find Me", null, PlaylistStatus.NEW, null, null));
    ...
    void findAll_returnsPaginatedResults() {
        repository.save(new Playlist(null, "A", null, PlaylistStatus.NEW, null, null));
        repository.save(new Playlist(null, "B", null, PlaylistStatus.NEW, null, null));
        repository.save(new Playlist(null, "C", null, PlaylistStatus.NEW, null, null));
    ...
    void softDelete_hidesRowFromSubsequentFinds() {
        Playlist saved = repository.save(new Playlist(null, "To Delete", null, PlaylistStatus.NEW, null, null));
        repository.flush();
    ...
    void findByNameContainingIgnoreCase_returnsMatches() {
        repository.save(new Playlist(null, "Chill Vibes", null, PlaylistStatus.NEW, null, null));
        repository.save(new Playlist(null, "Workout Hits", null, PlaylistStatus.NEW, null, null));
        repository.save(new Playlist(null, "Chillout Sessions", null, PlaylistStatus.NEW, null, null));
    ...
    void findByNameContainingIgnoreCase_isCaseInsensitive() {
        repository.save(new Playlist(null, "Late Night", null, PlaylistStatus.NEW, null, null));
