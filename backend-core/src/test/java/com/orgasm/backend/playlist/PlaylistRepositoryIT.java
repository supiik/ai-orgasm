...
class PlaylistRepositoryIT {
    ...
    void save_persistsPlaylist() {
        Playlist saved = repository.save(new Playlist(null, null, "My Mix", "a description", PlaylistStatus.NEW, null, null, null, null));
    ...
    void findById_returnsPlaylist_afterSave() {
        Playlist saved = repository.save(new Playlist(null, null, "Find Me", null, PlaylistStatus.NEW, null, null, null, null));
    ...
    void findAll_returnsPaginatedResults() {
        repository.save(new Playlist(null, null, "A", null, PlaylistStatus.NEW, null, null, null, null));
        repository.save(new Playlist(null, null, "B", null, PlaylistStatus.NEW, null, null, null, null));
        repository.save(new Playlist(null, null, "C", null, PlaylistStatus.NEW, null, null, null, null));
    ...
    void softDelete_hidesRowFromSubsequentFinds() {
        Playlist saved = repository.save(new Playlist(null, null, "To Delete", null, PlaylistStatus.NEW, null, null, null, null));
        repository.flush();
    ...
    void findByNameContainingIgnoreCase_returnsMatches() {
        repository.save(new Playlist(null, null, "Chill Vibes", null, PlaylistStatus.NEW, null, null, null, null));
        repository.save(new Playlist(null, null, "Workout Hits", null, PlaylistStatus.NEW, null, null, null, null));
        repository.save(new Playlist(null, null, "Chillout Sessions", null, PlaylistStatus.NEW, null, null, null, null));
    ...
    void findByNameContainingIgnoreCase_isCaseInsensitive() {
        repository.save(new Playlist(null, null, "Late Night", null, PlaylistStatus.NEW, null, null, null, null));
