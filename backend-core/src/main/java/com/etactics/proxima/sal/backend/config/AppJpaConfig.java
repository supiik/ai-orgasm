...
import com.etactics.proxima.sal.backend.tenant.CurrentTenantResolver;
...
@EnableJpaRepositories(
        basePackages = "com.etactics.proxima.sal.backend",
...
public class AppJpaConfig {
    ...
    LocalContainerEntityManagerFactoryBean appEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.etactics.proxima.sal.backend")
                .persistenceUnit("app")
