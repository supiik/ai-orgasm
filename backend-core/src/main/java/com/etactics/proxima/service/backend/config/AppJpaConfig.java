...
import com.etactics.proxima.service.backend.tenant.CurrentTenantResolver;
...
@EnableJpaRepositories(
        basePackages = "com.etactics.proxima.service.backend",
...
public class AppJpaConfig {
    ...
    LocalContainerEntityManagerFactoryBean appEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.etactics.proxima.service.backend")
                .persistenceUnit("app")
