...
const db: PlaylistResponse[] = [
  { id: 1, name: 'Chill Vibes', description: 'Relaxing tunes', version: 0, createdAt: '2024-01-01T10:00:00Z', updatedAt: '2024-01-01T10:00:00Z' },
  { id: 2, name: 'Workout Hits', description: 'High energy bangers', version: 0, createdAt: '2024-01-02T12:00:00Z', updatedAt: '2024-01-02T12:00:00Z' },
  { id: 3, name: 'Late Night', description: null, version: 1, createdAt: '2024-01-03T23:00:00Z', updatedAt: '2024-01-10T01:00:00Z' },
]
...
export const playlistHandlers = [
  ...
  http.put('/api/playlists/:id', async ({ params, request }) => {
    ...
    db[index] = { ...db[index], name: body.name, description: body.description ?? null, version: db[index].version + 1, updatedAt: now() }
